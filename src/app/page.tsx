...
{paymentCard.map((item,index) =>{
  return(
<div key={index} className="w-[26vw] HeightAvalible p-6 bg-white border border-gray-200  shadow-sm dark:bg-gray-800 dark:border-gray-700">
    ...
    <p className="my-5 font-normal text-gray-500 dark:text-gray-400">{item.description}</p>
